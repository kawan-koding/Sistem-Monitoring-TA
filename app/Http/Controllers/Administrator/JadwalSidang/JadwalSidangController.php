...
class JadwalSidangController extends Controller
{
    ...
    public function show(Sidang $sidang)
    {
        ...
        $recapPemb1 = isset($pembimbing1) && isset($pembimbing1->penilaian) ? $pembimbing1->penilaian()->where('type', 'Sidang')->sum('nilai') : 0;
        $recapPemb1 = $recapPemb1 > 0 && isset($pembimbing1) && isset($pembimbing1->penilaian) ? $recapPemb1 / $pembimbing1->penilaian()->where('type', 'Sidang')->count() : 0;
        $pembimbing2 = $sidang->tugas_akhir->bimbing_uji()->where('jenis', 'pembimbing')->where('urut', 2)->first();
        $recapPemb2 = isset($pembimbing2) && isset($pembimbing2->penilaian) ? $pembimbing2->penilaian()->where('type', 'Sidang')->sum('nilai') : 0;
        $recapPemb2 = $recapPemb2 > 0 && isset($pembimbing2) && isset($pembimbing2->penilaian) ? $recapPemb2 / $pembimbing2->penilaian()->where('type', 'Sidang')->count() : 0;
        ...
        $recapPenguji1 = isset($pengganti1) && isset($pengganti1->penilaian) ? $pengganti1->penilaian()->where('type', 'Sidang')->sum('nilai') : (isset($penguji1) && isset($penguji1->penilaian) ? $penguji1->penilaian()->where('type', 'Sidang')->sum('nilai') : 0);
        $countPenguji1 = isset($pengganti1) && isset($pengganti1->penilaian) ? $pengganti1->penilaian()->where('type', 'Sidang')->count() : (isset($penguji1) && isset($penguji1->penilaian) ? $penguji1->penilaian()->where('type', 'Sidang')->count() : 1);
        $recapPenguji1 = $recapPenguji1 > 0 ? $recapPenguji1 / $countPenguji1 : 0;
        ...
        $recapPenguji2 = isset($pengganti2) && isset($pengganti2->penilaian) ? $pengganti2->penilaian()->where('type', 'Sidang')->sum('nilai') : (isset($penguji2) && isset($penguji2->penilaian) ? $penguji2->penilaian()->where('type', 'Sidang')->sum('nilai') : 0);
        $countPenguji2 = isset($pengganti2) && isset($pengganti2->penilaian) ? $pengganti2->penilaian()->where('type', 'Sidang')->count() : (isset($penguji2) && isset($penguji2->penilaian) ? $penguji2->penilaian()->where('type', 'Sidang')->count() : 1);
        $recapPenguji2 = $recapPenguji2 > 0 ? $recapPenguji2 / $countPenguji2 : 0;
