...
<div class="row">
    <div class="col-md-12 col-sm-12 col-g-12">
        <div class="card">
            <div class="card-body">
                <a href="{{route('mahasiswa.pengajuan-ta')}}" class="btn btn-sm btn-secondary">Kembali</a>
                <hr>
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                        ...
                        <p>
                            @if ($data->status == 'acc')
                            <span class="badge rounded-pill badge-soft-primary font-size-12">Acc</span>
                            @else
                            <span class="badge rounded-pill badge-soft-secondary font-size-12">{{$data->status}}</span>
                            @endif
                        </p>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
