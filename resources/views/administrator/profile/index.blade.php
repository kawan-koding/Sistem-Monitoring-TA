                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="jenis_kelamin" id="" class="form-control">
                                            <option value="L" {{isset($profile->userable->jenis_kelamin) ? ($profile->userable->jenis_kelamin == 'Laki-laki' || $profile->userable->jenis_kelamin == 'L' ? 'selected' : '') : ''}}>Laki-laki</option>
                                            <option value="P" {{isset($profile->userable->jenis_kelamin) ? ($profile->userable->jenis_kelamin == 'Perempuan' || $profile->userable->jenis_kelamin == 'P' ? 'selected' : '') : ''}}>Perempuan</option>
                                        </select>
                                    </div>
                                    @if ($profile->hasRole(['Dosen', 'Admin', 'Kaprodi']))    
                                    <div class="mb-3">
