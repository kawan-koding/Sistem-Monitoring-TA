                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button title="Hapus" class="btn btn-outline-darkk btn-sm mx-1 my-1" data-toggle="delete-topik" data-url="{{ route('apps.hapus-topik-yang-diambil', $item->id) }}"><i class="bx bx-trash"></i></button>
                                    @else
                                    -
                                    @endif
                                </td>
