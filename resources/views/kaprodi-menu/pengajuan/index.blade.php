                    ...
                    <table class="table table-striped" id="datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-sm btn-success acc_ta mb-3" data-url="{{route('kaprodi.pengajuan-ta.acc', ['id' => $item->id])}}"><i class="fas fa-check-circle"></i></button>
                                    <button type="button" class="btn btn-sm btn-danger reject_ta mb-3" data-url="{{route('kaprodi.pengajuan-ta.reject', ['id' => $item->id])}}" ><i class="fas fa-minus-circle"></i></button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
        ...
        <form action="" id="formReject" method="post">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="">Catatan <span class="text-danger">*</span></label>
